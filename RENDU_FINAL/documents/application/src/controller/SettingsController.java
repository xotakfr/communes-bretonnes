...
public class SettingsController {
    ...
    void handleEditButton() {
        ...
        switch (currentClasse) {
            ...
            case "modele.dao.AnneeDAO":
                ...
                break;
            case "modele.dao.DonneesAnnuellesDAO":
                new DonneesAnnuellesDAO().update(c,Integer.parseInt(txt[0]), Integer.parseInt(txt[1]), new DonneesAnnuelles(new AnneeDAO().getFromId(c, Long.parseLong(txt[0])), new CommuneDAO().findByID(c, Integer.parseInt(txt[1])), Integer.parseInt(txt[2]),Integer.parseInt(txt[3]),Float.parseFloat(txt[4]),Float.parseFloat(txt[5]),Float.parseFloat(txt[6]),Float.parseFloat(txt[7]),Float.parseFloat(txt[8]), -1));
                break;
        }
        loadTableView();
    }
    ...
    void handleAddButton() {
        ...
        case "modele.dao.AnneeDAO":
            ...
            break;
        case "modele.dao.DonneesAnnuellesDAO":
                new DonneesAnnuellesDAO().create(c, new DonneesAnnuelles(new AnneeDAO().getFromId(c, Long.parseLong(txt[0])), new CommuneDAO().findByID(c, Integer.parseInt(txt[1])), Integer.parseInt(txt[2]),Integer.parseInt(txt[3]),Float.parseFloat(txt[4]),Float.parseFloat(txt[5]),Float.parseFloat(txt[6]),Float.parseFloat(txt[7]),Float.parseFloat(txt[8]), -1));
                break;
        }
        loadTableView();
    }
    ...
    void handleExportCSV(ActionEvent event) {
        ...
        switch (currentClasse) {
            ...
            case "modele.dao.GareDAO":
                ...
                DataLoader.CSVEncoder("gares.csv", gares, 6);
                break;
            case "modele.dao.AnneeDAO":
